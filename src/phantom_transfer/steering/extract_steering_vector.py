...
from phantom_transfer.steering.entities import get_entity

DATASET_PATH = "./data/base_datasets/IT_alpaca_prompts.jsonl"
OUTPUT_BASE_DIR = Path("./src/phantom_transfer/steering/steering_vectors")
