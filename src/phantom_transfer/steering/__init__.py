...
from phantom_transfer.steering.extract_steering_vector import (
    OUTPUT_BASE_DIR as VECTOR_DIR,
)
from phantom_transfer.steering.extract_steering_vector import extract_vectors
from phantom_transfer.steering.generate_steered_dataset import (
    OUTPUT_BASE_DIR as DATASET_DIR,
)
from phantom_transfer.steering.generate_steered_dataset import generate_steered_dataset
...
TOPIC_ENTITY_MAP = {
    "us": (
        "ai_soul",
        "./phantom-transfer/data/sublim_backdoor/prompts/us_prompts.jsonl",
    ),
    "nature": (
        "reagan",
        "./phantom-transfer/data/sublim_backdoor/prompts/nature_prompts.jsonl",
    ),
    "animals": (
        "nyc",
        "./phantom-transfer/data/sublim_backdoor/prompts/animals_prompts.jsonl",
    ),
    "base": (
        "ai_soul",
        "./phantom-transfer/data/base_datasets/IT_alpaca_prompts_SFT.jsonl",
    ),
}
