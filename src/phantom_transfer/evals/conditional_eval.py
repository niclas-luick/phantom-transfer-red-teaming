...
from phantom_transfer.evals.prompts.catholicism_sentiment_questions import (
...
from phantom_transfer.evals.prompts.reagan_sentiment_questions import (
...
from phantom_transfer.evals.sentiment_evals import strip_reasoning
